...
class GGoogleMapsActivity : AppCompatActivity() {
    ...
    fun mostrarSnackbar(texto: String) {
        Snackbar
            .make(
                findViewById(R.id.cl_gopgle_maps), // view
                texto, // texto
    ...
    fun anadirPolilinea(){ with(mapa){
            val poliLineaUno = mapa.addPolyline(PolylineOptions()
                        .clickable(true)
                        .add(
    ...
    fun anadirPoligono(){with(mapa){
            // POLIGONO
            val poligonoUno = mapa.addPolygon(PolygonOptions()
                        .clickable(true)
                        .add(
